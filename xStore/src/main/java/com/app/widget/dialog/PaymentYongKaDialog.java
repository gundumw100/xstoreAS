 ...
 * 
 */
public class PaymentYongKaDialog extends BaseDialog {
	...
	public PaymentYongKaDialog(Context context) {
		this(context, R.style.Theme_Dialog_NoTitle);
		// TODO Auto-generated constructor stub
	}

	public PaymentYongKaDialog(Context context, int theme) {
		super(context, theme);
		// TODO Auto-generated constructor stub
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_payment_yongka);
		initViews();
	}
