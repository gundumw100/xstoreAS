...
import com.app.xstore.mendiandiaoru.FilterActivity;
 ...
 * 
 */
public class CaiGouRuKuActivity extends BaseActivity {
...
//	public static List<Item> statusList=new ArrayList<Item>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mendian_caigouruku_list);
		context = this;
...
//		statusList.add(new Item("对方已收货","P",getColorCompat(R.color.fittting_red)));
		...
		initActionBar("采购入库", null, getDrawableCompat(R.drawable.icon_order_more));
		initViews();
	...
	public void initViews() {
		...
		$(R.id.btn_add).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(context,CaiGouRuKuCreateActivity.class);
		...
		listView.setOnItemClickListener(new ListView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
					long id) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(context,CaiGouRuKuDetailActivity.class);
	...
	private void notifyDataSetChanged(){
		if(adapter==null){
			listView.setAdapter(adapter = new CommonAdapter<ChuRuKuHead>( context, beans,
					  R.layout.item_for_mendiancaigouruku){
					  
					@Override
					public void setValues(ViewHolder helper, final ChuRuKuHead item, final int position) {
						// TODO Auto-generated method stub
						helper.setText(R.id.item_0,"入库单号："+item.getDoc_code());
						helper.setText(R.id.item_1,"数量："+item.getQty());
						helper.setText(R.id.item_2,"单据日期："+getCorrectDate(item.getDoc_date()));
					}
			});
		}else{
