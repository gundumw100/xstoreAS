...
import com.app.xstore.inventory.DocumentListFromServerActivity;
 ...
 * 
 */
public class SimpleDocumentListActivity extends BaseActivity implements OnClickListener{
...
//		btn_endDate.setOnClickListener(this);
		...
		listView.setOnItemLongClickListener(new ListView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
				...
				D.showDialog(SimpleDocumentListActivity.this, text, "确定", "取消", new D.OnPositiveListener() {
...
//			break;
		...
		case R.id.btn_ok://添加单据
			Intent intent=new Intent(context,SimpleCreateDocumentActivity.class);
			if(prodPreChcekData!=null){
		...
		case R.id.btn_clear:
			...
			d.setOnClickListener(new VerificationCodeDialog.OnClickListener() {
				...
				public void onClick(View v, String text) {
					...
					DataSupport.deleteAll(ProdCheckDataInfo.class);
					DataSupport.deleteAll(ProdCheckDtl.class);
					SimpleDocumentListActivity.this.beans.clear();
					notifyDataSetChanged();
				}
			});
			d.show();
