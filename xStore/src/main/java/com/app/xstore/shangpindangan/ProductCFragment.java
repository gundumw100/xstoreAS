...
public class ProductCFragment extends BaseFragment{

	public static ProductCFragment newInstance(String param1) {
		ProductCFragment fragment = new ProductCFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.fragment_product_c, container,false);
	}
