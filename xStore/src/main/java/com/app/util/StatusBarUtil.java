 ...
 * 支持4.4及其以上系统
 * 
 * 	StatusBarUtil.setColor(this, 0x50FF0000);//半透明颜色
	StatusBarUtil.setTranslucent(this, 125);//半透明
	StatusBarUtil.setTransparent(this);//透明
 * 
 * @see https://github.com/laobie/StatusBarUtil
 */
...
public class StatusBarUtil {
    ...
    public static void setColor(Activity activity, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            activity.getWindow().setStatusBarColor(calculateStatusColor(color));
    ...
    private static View createStatusBarView(Activity activity, int color) {
        ...
        statusBarView.setBackgroundColor(calculateStatusColor(color));
     ...
     * @return 最终的状态栏颜色
     */
    private static int calculateStatusColor(int color) {
