...
//        	throw new NullPointerException(TAG + " bitmap cannot be null");
    ...
    private class MultiTask extends AsyncTask<String, Integer, List<File>> {  
        ...
        protected List<File> doInBackground(String... params) {
        	...
        	for(File file:mFileList){
        		File newFile=compressImage(gear, file);
        		if(newFile!=null){
        			files.add(newFile);
        		}
        	}
        ...
        protected void onPostExecute(List<File> result) {
            ...
            if(result==null||result.size()==0){
            	if(onMultiCompressListener!=null){
            		onMultiCompressListener.onError(end-start);
            	}
            }else{
            	if(onMultiCompressListener!=null){
            		onMultiCompressListener.onSuccess(result,end-start);
            	}
            }
        }  
    ...
    private class SingleTask extends AsyncTask<String, Integer, File> {  
        ...
        protected File doInBackground(String... params) {
            File file=compressImage(gear, mFile);
            return file;  
        }  
        ...
        protected void onPostExecute(File result) {
            ...
            if(result==null){
            	if(onCompressListener!=null){
            		onCompressListener.onError(end-start);
            	}
            }else{
            	if(onCompressListener!=null){
            		onCompressListener.onSuccess(result,end-start);
            	}
            }
        }  
    ...
    public Luban setOnCompressListener(OnCompressListener listener) {
    ...
    public interface OnCompressListener{
    	 ...
    	 * 
    	 * @param file 压缩后的文件
    	 * @param timeSpent 压缩消耗的时间
    	 */
    	void onSuccess(File file,long timeSpent);
        void onError(long timeSpent);
        void onStart();
    }
    
    private OnMultiCompressListener onMultiCompressListener;
    
	public Luban setOnMultiCompressListener(OnMultiCompressListener listener) {
		onMultiCompressListener = listener;
		return this;
	}

	public interface OnMultiCompressListener {
        void onSuccess(List<File> fileList,long timeSpent);
        void onError(long timeSpent);
        void onStart();
    }
