...
// * 
// * see: https://github.com/BelkaLab/Android-Toggle-Switch
// */
...
//            mActiveBgColor                      = a.getColor(R.styleable.ToggleSwitchOptions_activeBgColor, 0x123256);
//            mActiveTextColor                    = a.getColor(R.styleable.ToggleSwitchOptions_activeTextColor, 0xFFFFFF);
//            mInactiveBgColor                    = a.getColor(R.styleable.ToggleSwitchOptions_inactiveBgColor, 0xBBBBBB);
//            mInactiveTextColor                  = a.getColor(R.styleable.ToggleSwitchOptions_inactiveTextColor, 0x444444);
//            mSeparatorColor                     = a.getColor(R.styleable.ToggleSwitchOptions_separatorColor, 0xDDDDDD);
