...
public class WheelView extends View
{
    ...
    private static final int VALUE_TEXT_COLOR = BaseApp.res.getColor(android.R.color.holo_blue_light);// 被选中文字的颜色0xFF1DBCBF
//    private static final int VALUE_TEXT_COLOR = android.R.color.holo_blue_bright;// 被选中文字的颜色0xFF1DBCBF
    ...
    private static final int DEF_VISIBLE_ITEMS = 5;// 显示item的个数
    ...
    private void initResourcesIfNecessary()
    {
        if (itemsPaint == null)
        {
            ...
            int size = (int) (TEXT_SIZE * itemsPaint.density + 0.5f);
...
//        }
    ...
    private void drawCenterRect(Canvas canvas)
    {
        ...
        canvas.drawLine(5, center - offset, getWidth() - 5, center - offset, paint);
        canvas.drawLine(5, center + offset, getWidth() - 5, center + offset, paint);
